 ...
 */
public class RealAGVDemoCommAdapterPanelFactory
    implements VehicleCommAdapterPanelFactory {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(RealAGVDemoCommAdapterPanelFactory.class);
  /**
   * The service portal.
   */
   ...
   */
  @Inject
  public RealAGVDemoCommAdapterPanelFactory(KernelServicePortal servicePortal,
  ...
  public List<VehicleCommAdapterPanel> getPanelsFor(
    ...
    panels.add(componentsFactory.createControlPanel((RealAGVDemoProcessModelTO) processModel,
                                                    servicePortal.getVehicleService()));
    panels.add(componentsFactory.createStatusPanel((RealAGVDemoProcessModelTO) processModel,
                                                   servicePortal.getVehicleService()));
    return panels;
  }
  ...
  private boolean providesPanelsFor(VehicleCommAdapterDescription description,
    ...
    return (description instanceof RealAGVDemoCommAdapterDescription)
        && (processModel instanceof RealAGVDemoProcessModelTO);
  }
}
