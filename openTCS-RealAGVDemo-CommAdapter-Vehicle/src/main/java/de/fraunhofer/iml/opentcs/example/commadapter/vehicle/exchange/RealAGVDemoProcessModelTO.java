...
import de.fraunhofer.iml.opentcs.example.commadapter.vehicle.RealAGVDemoProcessModel;
...
/**
 * A serializable representation of a {@link RealAGVDemoProcessModel}.
 ...
 */
public class RealAGVDemoProcessModelTO
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setVehicleRef(TCSObjectReference<Vehicle> vehicleRef) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setCurrentState(
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setPreviousState(
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setLastOrderSent(
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setVehicleHost(String vehicleHost) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setVehiclePort(int vehiclePort) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setPeriodicStateRequestEnabled(boolean periodicStateRequestEnabled) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setStateRequestInterval(int stateRequestInterval) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setVehicleIdleTimeout(int vehicleIdleTimeout) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setVehicleIdle(boolean vehicleIdle) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setDisconnectingOnVehicleIdle(boolean disconnectingOnVehicleIdle) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setReconnectingOnConnectionLoss(boolean reconnectingOnConnectionLoss) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setReconnectDelay(int reconnectDelay) {
   ...
   * @return This
   */
  public RealAGVDemoProcessModelTO setLoggingEnabled(boolean loggingEnabled) {
