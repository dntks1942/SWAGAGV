 ...
 */
public class RealAGVDemoCommAdapterFactoryTest {

  private RealAGVDemoCommAdapterFactory commAdapterFactory;

  @Before
  public void setUp() {
    commAdapterFactory = new RealAGVDemoCommAdapterFactory(mock(RealAGVDemoAdapterComponentsFactory.class));
  }
